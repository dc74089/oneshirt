...
def trade_mail(trade):
    ...
    send_mail(subject, plain, "webmaster@mail.frcshirt.trade", [trade.take.owner.email], html_message=html)
...
def trade_accepted_mail(trade):
    ...
    send_mail(subject, plain, "webmaster@mail.frcshirt.trade", [trade.give.owner.email], html_message=html)
